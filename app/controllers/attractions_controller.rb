class AttractionsController < ApplicationController
  ...
  private
    ...
    def attraction_params
      params.require(:attraction).permit(:email_address, :itinerary_reference, :reference_term, :name, :confirmation_number, :item_name, :start_date_time, :end_date_time, :city, :state, :country, :street_address, :zip_code)
    end
end
